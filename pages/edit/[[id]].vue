<template>
  <div class="flex-grow p-4 sm:p-10">
    <div class="flex justify-between pb-2">
      <NuxtLink to="/" class="flex items-center sm:gap-2">
        <svg
          ...
          fill="currentColor" stroke="white" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <div id="stage-nav" class="flex overflow-x-auto whitespace-nowrap items-center gap-4">
      ...
      <ul class="flex gap-5 text-lg font-semibold">
        <li 
          ...
          v-for="(item,i) in stageList" :key="i">
          {{ item.name }}
        </li>
      </ul>
    </div>
    ...
    <div class="mt-4">
      <div v-show="activeStage === 1">
        <form @submit.prevent="" class="sm:grid grid-cols-2 gap-10 overflow-y-auto">
          <div class="px-1 pb-1">
            <label for="name" class="relative flex items-center mt-[20px] 2xl:mt-10">
              <svg
            ...
            <label for="phone" class="relative flex items-center mt-[20px] 2xl:mt-10">
              <svg
                class="w-6 h-6 absolute left-3 text-primary"
                fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <label for="gender" class="relative flex items-center mt-[20px] 2xl:mt-10">
              <svg
                class="w-6 h-6 absolute left-3 text-primary"
            ...
            <label for="location" class="relative flex items-center mt-[20px] 2xl:mt-10">
              <svg
                class="w-6 h-6 absolute left-3 text-primary"
                fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <form @submit.prevent="" class="sm:grid grid-cols-2 gap-10 overflow-y-auto">
          <div class="px-1 pb-1 sm:max-h-[calc(100vh-200px)]">
            ...
            <label for="their-pet-name" class="block mt-[20px] 2xl:mt-10">
              ...
              <input
                :value="stageThree.userPetNamesForClient"
                class="w-full border-2 border-black border-opacity-10 rounded-2xl px-[18px] py-[14px]
            ...
            <label for="purpose" class="block mt-[20px] 2xl:mt-10">
              <strong class="font-semibold">Purpose of call</strong>
              <textarea
                :value="stageThree.reasonForCall"
                class="w-full border-2 border-black border-opacity-10 rounded-2xl px-[18px] py-[14px]
                placeholder-opacity-50 outline-none min-h-[200px] max-h-[300px]
                focus:border-opacity-0 focus:ring-2 focus:ring-primary"
                name="purpose"
                disabled
            ...
            <label for="your-words" class="block my-[20px] 2xl:my-10">
              <strong class="font-semibold">Clients words</strong>
              <textarea
                :value="stageThree.customMessage"
                class="w-full border-2 border-black border-opacity-10 rounded-2xl px-[18px] py-[14px]
                placeholder-opacity-50 outline-none min-h-[200px] max-h-[300px]
                focus:border-opacity-0 focus:ring-2 focus:ring-primary"
                name="your-words"
          ...
          <div class="px-1 pb-1 sm:max-h-[calc(100vh-200px)]">
            <label for="language" class="block mt-[20px] 2xl:mt-10">
              ...
              <input
                :value="stageThree.nativeLanguage"
                class="w-full border-2 border-black border-opacity-10 rounded-2xl px-[18px] py-[14px]
                placeholder-opacity-50 outline-none focus:border-opacity-0 focus:ring-2 focus:ring-primary"
                type="text"
                name="language"
            ...
            <label for="your-pet-name" class="block mt-[20px] 2xl:mt-10">
              ...
              <input
                :value="stageThree.clientPetNamesForUser"
                class="w-full border-2 border-black border-opacity-10 rounded-2xl px-[18px] py-[14px]
                placeholder-opacity-50 outline-none
                focus:border-opacity-0 focus:ring-2 focus:ring-primary"
                type="text"
            ...
            <label for="names-you-are-called" class="block mt-[20px] 2xl:mt-10">
              <strong class="font-semibold">Name(s) loved one know client as</strong>
              <input
                :value="stageThree.userNickNames"
                class="w-full border-2 border-black border-opacity-10 rounded-2xl px-[18px] py-[14px]
                placeholder-opacity-50 outline-none
                focus:border-opacity-0 focus:ring-2 focus:ring-primary"
                type="text"
            ...
            <label for="fav-memories" class="block my-[20px] 2xl:my-10">
              <strong class="font-semibold">Some favorite memories</strong>
              <textarea
                :value="stageThree.favoriteMemories"
                class="w-full border-2 border-black border-opacity-10 rounded-2xl px-[18px] py-[14px]
                placeholder-opacity-50 outline-none min-h-[200px] max-h-[300px]
                focus:border-opacity-0 focus:ring-2 focus:ring-primary"
                name="fav-memories"
        ...
        <form @submit.prevent="" class="sm:grid grid-cols-2 gap-10">
          <div class="px-1 py-1">
            ...
            <div class="mt-[20px] 2xl:mt-10">
              <strong class="flex-grow">When they want the call to be made</strong>
              <div class="flex gap-4">
                <input
                  :value="stageFour.whenToCallDate"
                  class="w-full border-2 border-black border-opacity-10 rounded-2xl px-[18px] py-[14px]
                  placeholder-opacity-50 outline-none
                  focus:border-opacity-0 focus:ring-2 focus:ring-primary"
                  type="date"
                  ...
                  disabled>
                <input
                  :value="stageFour.whenToCallTime"
                  class="w-full border-2 border-black border-opacity-10 rounded-2xl px-[18px] py-[14px]
                  placeholder-opacity-50 outline-none
                  focus:border-opacity-0 focus:ring-2 focus:ring-primary"
                  type="time"
...
onMounted(async ()=>{
  ...
  if(booking.bookingType === BookingType.GUEST){
    ...
    clientDetails.maritalStatus = (booking.guestDetails?.maritalStatus || '') as MaritalStatus
    clientDetails.salutation = booking.guestDetails?.title || ''
  } else {
    // fetch booking creator

    //booking.createdBy?._id || booking.createdBy -> this is just a safety net since I don't understand the use of TS on this app
    const creator = await fetchViewedBookingCreator(booking.createdBy?._id || booking.createdBy)
    ...
    clientDetails.location = creator?.location?.name || ''
    clientDetails.maritalStatus = (creator?.maritalStatus || '') as MaritalStatus
  ...
  stageThree.userPetNamesForClient = booking?.userPetNamesForClient.join(', ') || ''
  stageThree.clientPetNamesForUser = booking?.clientPetNamesForUser.join(', ') || ''
  ...
  stageFour.whenToCallDate = new Date(booking?.availabilityCalendar[0].to).toJSON().split("T")[0] || ''
  stageFour.whenToCallTime = new Date(booking?.availabilityCalendar[0].to).toJSON().split("T")[1].replace("Z","") || ''
  stageFour.isRecorded = booking?.isRecorded || false
  stageFour.chargeType = booking?.chargeType || ''
})

const bootstrapViewedBooking = async (bookingId: string): Promise<BookingItem | undefined> => {
  if(!bookingId) {
  ...
  const bookingFromStore = await bookingStore.getBookingById(bookingId)
    .catch(async () => {
...
const fetchViewedBookingCreator = async (userId: string): Promise<User | undefined> => {
  try {
...
const CountryName = computed(() => bookingStore.countryCodes.find((country) => country._id === stageTwo.countryCode)?.country)
onMounted(()=>{
